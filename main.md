...
## 🔶2. 개발과 운영
> 가장 중요하고 가장 할 말이 많지만 또한 경험하기 전엔 이해하기 어려운 주제
...
### ➡️ 매뉴얼 작성할 때 팁
- 갑자기 장애가 나서 이 업무를 처리해야 하는데, 지금 당장 이 일을 해결해 줄 사람이 우리 사장님 밖에 없다고 가정한 뒤, 사장님이 내 자리에 오셔서 이 매뉴얼만 보고 순서대로 따라 해도 처리가 가능한가?
- 현재의 내가 '**미래의 나**'에게 보내는 선물 - 언젠간 과거의 나에게 고마워 할 날이 온다.
...
- 언젠가는 회사생활에 도움이 될 만한 것
- 또는 기억에 남을만한 것이 하나라도 있었기를 바라며
